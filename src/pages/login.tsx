...
export default function Login() {
  return (
    <div className="w-full h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat "  style={{backgroundImage:`url(${Fundo1})`}}>
      <div className="w-1/4 h-2/4 flex flex-col items-center justify-center bg-gray-50 rounded-2xl">
        <form>
          ...
          <div className="signup-link text-center mt-4">
            ...
            <a href="./cadastro" className="text-blue-700">Regista-te</a>
          </div>
        </form>
      </div>
    </div>
